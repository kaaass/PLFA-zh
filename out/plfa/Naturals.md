...
{% raw %}<pre class="Agda"><a id="1618" class="Keyword">data</a> <a id="ℕ"></a><a id="1623" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1623" class="Datatype">ℕ</a> <a id="1625" class="Symbol">:</a> <a id="1627" class="PrimitiveType">Set</a> <a id="1631" class="Keyword">where</a>
  <a id="ℕ.zero"></a><a id="1639" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1639" class="InductiveConstructor">zero</a> <a id="1644" class="Symbol">:</a> <a id="1646" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a>
  <a id="ℕ.suc"></a><a id="1650" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a>  <a id="1655" class="Symbol">:</a> <a id="1657" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="1659" class="Symbol">→</a> <a id="1661" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="3133" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="12468" class="Symbol">{-#</a> <a id="12472" class="Keyword">BUILTIN</a> <a id="12480" class="Pragma">NATURAL</a> <a id="12488" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1623" class="Datatype">ℕ</a> <a id="12490" class="Symbol">#-}</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="14032" class="Keyword">import</a> <a id="14039" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.html" class="Module">Relation.Binary.PropositionalEquality</a> <a id="14077" class="Symbol">as</a> <a id="14080" class="Module">Eq</a>
<a id="14083" class="Keyword">open</a> <a id="14088" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.html" class="Module">Eq</a> <a id="14091" class="Keyword">using</a> <a id="14097" class="Symbol">(</a><a id="14098" href="https://agda.github.io/agda-stdlib/v1.1/Agda.Builtin.Equality.html#125" class="Datatype Operator">_≡_</a><a id="14101" class="Symbol">;</a> <a id="14103" href="Agda.Builtin.Equality.html#182" class="InductiveConstructor">refl</a><a id="14107" class="Symbol">)</a>
<a id="14109" class="Keyword">open</a> <a id="14114" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2499" class="Module">Eq.≡-Reasoning</a> <a id="14129" class="Keyword">using</a> <a id="14135" class="Symbol">(</a><a id="14136" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin_</a><a id="14142" class="Symbol">;</a> <a id="14144" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">_≡⟨⟩_</a><a id="14149" class="Symbol">;</a> <a id="14151" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">_∎</a><a id="14153" class="Symbol">)</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="_+_"></a><a id="16727" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">_+_</a> <a id="16731" class="Symbol">:</a> <a id="16733" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="16735" class="Symbol">→</a> <a id="16737" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="16739" class="Symbol">→</a> <a id="16741" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a>
<a id="16743" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1639" class="InductiveConstructor">zero</a> <a id="16748" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="16750" href="plfa.Naturals.html#16750" class="Bound">n</a> <a id="16752" class="Symbol">=</a> <a id="16754" href="plfa.Naturals.html#16750" class="Bound">n</a>
<a id="16756" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="16760" href="plfa.Naturals.html#16760" class="Bound">m</a> <a id="16762" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="16764" href="plfa.Naturals.html#16764" class="Bound">n</a> <a id="16766" class="Symbol">=</a> <a id="16768" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="16772" class="Symbol">(</a><a id="16773" href="plfa.Naturals.html#16760" class="Bound">m</a> <a id="16775" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="16777" href="plfa.Naturals.html#16764" class="Bound">n</a><a id="16778" class="Symbol">)</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="19476" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#19476" class="Function">_</a> <a id="19478" class="Symbol">:</a> <a id="19480" class="Number">2</a> <a id="19482" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19484" class="Number">3</a> <a id="19486" href="https://agda.github.io/agda-stdlib/v1.1/Agda.Builtin.Equality.html#125" class="Datatype Operator">≡</a> <a id="19488" class="Number">5</a>
<a id="19490" class="Symbol">_</a> <a id="19492" class="Symbol">=</a>
  <a id="19496" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin</a>
    <a id="19506" class="Number">2</a> <a id="19508" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">+</a> <a id="19510" class="Number">3</a>
  <a id="19514" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="19521" class="Comment">-- 展开为</a>
    <a id="19532" class="Symbol">(</a><a id="19533" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19537" class="Symbol">(</a><a id="19538" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19542" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19546" class="Symbol">))</a> <a id="19549" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19551" class="Symbol">(</a><a id="19552" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19556" class="Symbol">(</a><a id="19557" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19561" class="Symbol">(</a><a id="19562" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19566" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19570" class="Symbol">)))</a>
  <a id="19576" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="19583" class="Comment">-- 归纳步骤</a>
    <a id="19595" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19599" class="Symbol">((</a><a id="19601" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19605" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19609" class="Symbol">)</a> <a id="19611" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19613" class="Symbol">(</a><a id="19614" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19618" class="Symbol">(</a><a id="19619" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19623" class="Symbol">(</a><a id="19624" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19628" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19632" class="Symbol">))))</a>
  <a id="19639" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="19646" class="Comment">-- 归纳步骤</a>
    <a id="19658" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19662" class="Symbol">(</a><a id="19663" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19667" class="Symbol">(</a><a id="19668" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a> <a id="19673" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19675" class="Symbol">(</a><a id="19676" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19680" class="Symbol">(</a><a id="19681" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19685" class="Symbol">(</a><a id="19686" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19690" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19694" class="Symbol">)))))</a>
  <a id="19702" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="19709" class="Comment">-- 起始步骤</a>
    <a id="19721" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19725" class="Symbol">(</a><a id="19726" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19730" class="Symbol">(</a><a id="19731" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19735" class="Symbol">(</a><a id="19736" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19740" class="Symbol">(</a><a id="19741" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="19745" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a><a id="19749" class="Symbol">))))</a>
  <a id="19756" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="19763" class="Comment">-- 简写为</a>
    <a id="19774" class="Number">5</a>
  <a id="19778" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">∎</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="19925" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#19925" class="Function">_</a> <a id="19927" class="Symbol">:</a> <a id="19929" class="Number">2</a> <a id="19931" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19933" class="Number">3</a> <a id="19935" href="https://agda.github.io/agda-stdlib/v1.1/Agda.Builtin.Equality.html#125" class="Datatype Operator">≡</a> <a id="19937" class="Number">5</a>
<a id="19939" class="Symbol">_</a> <a id="19941" class="Symbol">=</a>
  <a id="19945" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin</a>
    <a id="19955" class="Number">2</a> <a id="19957" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">+</a> <a id="19959" class="Number">3</a>
  <a id="19963" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
    <a id="19971" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19975" class="Symbol">(</a><a id="19976" class="Number">1</a> <a id="19978" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="19980" class="Number">3</a><a id="19981" class="Symbol">)</a>
  <a id="19985" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
    <a id="19993" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="19997" class="Symbol">(</a><a id="19998" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="20002" class="Symbol">(</a><a id="20003" class="Number">0</a> <a id="20005" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="20007" class="Number">3</a><a id="20008" class="Symbol">))</a>
  <a id="20013" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
    <a id="20021" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="20025" class="Symbol">(</a><a id="20026" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="20030" class="Number">3</a><a id="20031" class="Symbol">)</a>
  <a id="20035" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
    <a id="20043" class="Number">5</a>
  <a id="20047" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">∎</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="21516" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#21516" class="Function">_</a> <a id="21518" class="Symbol">:</a> <a id="21520" class="Number">2</a> <a id="21522" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="21524" class="Number">3</a> <a id="21526" href="https://agda.github.io/agda-stdlib/v1.1/Agda.Builtin.Equality.html#125" class="Datatype Operator">≡</a> <a id="21528" class="Number">5</a>
<a id="21530" class="Symbol">_</a> <a id="21532" class="Symbol">=</a> <a id="21534" href="https://agda.github.io/agda-stdlib/v1.1/Agda.Builtin.Equality.html#182" class="InductiveConstructor">refl</a>
</pre>{% endraw %}
{::comment}
...
{::comment}
{% raw %}<pre class="Agda"><a id="23496" class="Comment">-- Your code goes here</a>
</pre>{% endraw %}{:/}

{% raw %}<pre class="Agda"><a id="23533" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
Multiplication
{:/}
...
{% raw %}<pre class="Agda"><a id="_*_"></a><a id="23724" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#23724" class="Function Operator">_*_</a> <a id="23728" class="Symbol">:</a> <a id="23730" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="23732" class="Symbol">→</a> <a id="23734" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="23736" class="Symbol">→</a> <a id="23738" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a>
<a id="23740" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1639" class="InductiveConstructor">zero</a>    <a id="23748" href="plfa.Naturals.html#23724" class="Function Operator">*</a> <a id="23750" href="plfa.Naturals.html#23750" class="Bound">n</a>  <a id="23753" class="Symbol">=</a>  <a id="23756" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a>
<a id="23761" class="Symbol">(</a><a id="23762" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="23766" href="plfa.Naturals.html#23766" class="Bound">m</a><a id="23767" class="Symbol">)</a> <a id="23769" href="plfa.Naturals.html#23724" class="Function Operator">*</a> <a id="23771" href="plfa.Naturals.html#23771" class="Bound">n</a>  <a id="23774" class="Symbol">=</a>  <a id="23777" href="plfa.Naturals.html#23771" class="Bound">n</a> <a id="23779" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="23781" class="Symbol">(</a><a id="23782" href="plfa.Naturals.html#23766" class="Bound">m</a> <a id="23784" href="plfa.Naturals.html#23724" class="Function Operator">*</a> <a id="23786" href="plfa.Naturals.html#23771" class="Bound">n</a><a id="23787" class="Symbol">)</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="24947" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#24947" class="Function">_</a> <a id="24949" class="Symbol">=</a>
  <a id="24953" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin</a>
    <a id="24963" class="Number">2</a> <a id="24965" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#23724" class="Function Operator">*</a> <a id="24967" class="Number">3</a>
  <a id="24971" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="24978" class="Comment">-- 归纳步骤</a>
    <a id="24990" class="Number">3</a> <a id="24992" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">+</a> <a id="24994" class="Symbol">(</a><a id="24995" class="Number">1</a> <a id="24997" href="plfa.Naturals.html#23724" class="Function Operator">*</a> <a id="24999" class="Number">3</a><a id="25000" class="Symbol">)</a>
  <a id="25004" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="25011" class="Comment">-- 归纳步骤</a>
    <a id="25023" class="Number">3</a> <a id="25025" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">+</a> <a id="25027" class="Symbol">(</a><a id="25028" class="Number">3</a> <a id="25030" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="25032" class="Symbol">(</a><a id="25033" class="Number">0</a> <a id="25035" href="plfa.Naturals.html#23724" class="Function Operator">*</a> <a id="25037" class="Number">3</a><a id="25038" class="Symbol">))</a>
  <a id="25043" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="25050" class="Comment">-- 起始步骤</a>
    <a id="25062" class="Number">3</a> <a id="25064" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Function Operator">+</a> <a id="25066" class="Symbol">(</a><a id="25067" class="Number">3</a> <a id="25069" href="plfa.Naturals.html#16727" class="Function Operator">+</a> <a id="25071" class="Number">0</a><a id="25072" class="Symbol">)</a>
  <a id="25076" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>    <a id="25083" class="Comment">-- 化简</a>
    <a id="25093" class="Number">6</a>
  <a id="25097" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">∎</a>
</pre>{% endraw %}
{::comment}
The first line matches the inductive case by taking `m = 1` and `n = 3`,
The second line matches the inductive case by taking `m = 0` and `n = 3`,
...
{::comment}
{% raw %}<pre class="Agda"><a id="25802" class="Comment">-- Your code goes here</a>
</pre>{% endraw %}{:/}

{% raw %}<pre class="Agda"><a id="25839" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
...
{::comment}
{% raw %}<pre class="Agda"><a id="26172" class="Comment">-- Your code goes here</a>
</pre>{% endraw %}{:/}

{% raw %}<pre class="Agda"><a id="26209" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
Monus
{:/}
...
{% raw %}<pre class="Agda"><a id="_∸_"></a><a id="26753" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">_∸_</a> <a id="26757" class="Symbol">:</a> <a id="26759" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="26761" class="Symbol">→</a> <a id="26763" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a> <a id="26765" class="Symbol">→</a> <a id="26767" href="plfa.Naturals.html#1623" class="Datatype">ℕ</a>
<a id="26769" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26769" class="Bound">m</a>     <a id="26775" href="plfa.Naturals.html#26753" class="Function Operator">∸</a> <a id="26777" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a>   <a id="26784" class="Symbol">=</a>  <a id="26787" href="plfa.Naturals.html#26769" class="Bound">m</a>
<a id="26789" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1639" class="InductiveConstructor">zero</a>  <a id="26795" href="plfa.Naturals.html#26753" class="Function Operator">∸</a> <a id="26797" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="26801" href="plfa.Naturals.html#26801" class="Bound">n</a>  <a id="26804" class="Symbol">=</a>  <a id="26807" href="plfa.Naturals.html#1639" class="InductiveConstructor">zero</a>
<a id="26812" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#1650" class="InductiveConstructor">suc</a> <a id="26816" href="plfa.Naturals.html#26816" class="Bound">m</a> <a id="26818" href="plfa.Naturals.html#26753" class="Function Operator">∸</a> <a id="26820" href="plfa.Naturals.html#1650" class="InductiveConstructor">suc</a> <a id="26824" href="plfa.Naturals.html#26824" class="Bound">n</a>  <a id="26827" class="Symbol">=</a>  <a id="26830" href="plfa.Naturals.html#26816" class="Bound">m</a> <a id="26832" href="plfa.Naturals.html#26753" class="Function Operator">∸</a> <a id="26834" href="plfa.Naturals.html#26824" class="Bound">n</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="27627" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#27627" class="Function">_</a> <a id="27629" class="Symbol">=</a>
  <a id="27633" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin</a>
     <a id="27644" class="Number">3</a> <a id="27646" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27648" class="Number">2</a>
  <a id="27652" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27661" class="Number">2</a> <a id="27663" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27665" class="Number">1</a>
  <a id="27669" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27678" class="Number">1</a> <a id="27680" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27682" class="Number">0</a>
  <a id="27686" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27695" class="Number">1</a>
  <a id="27699" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">∎</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="27888" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#27888" class="Function">_</a> <a id="27890" class="Symbol">=</a>
  <a id="27894" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2597" class="Function Operator">begin</a>
     <a id="27905" class="Number">2</a> <a id="27907" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27909" class="Number">3</a>
  <a id="27913" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27922" class="Number">1</a> <a id="27924" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27926" class="Number">2</a>
  <a id="27930" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27939" class="Number">0</a> <a id="27941" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Function Operator">∸</a> <a id="27943" class="Number">1</a>
  <a id="27947" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2655" class="Function Operator">≡⟨⟩</a>
     <a id="27956" class="Number">0</a>
  <a id="27960" href="https://agda.github.io/agda-stdlib/v1.1/Relation.Binary.PropositionalEquality.Core.html#2892" class="Function Operator">∎</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="28248" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
Precedence
{:/}
...
{% raw %}<pre class="Agda"><a id="29123" class="Keyword">infixl</a> <a id="29130" class="Number">6</a>  <a id="29133" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Primitive Operator">_+_</a>  <a id="29138" href="plfa.Naturals.html#26753" class="Primitive Operator">_∸_</a>
<a id="29142" class="Keyword">infixl</a> <a id="29149" class="Number">7</a>  <a id="29152" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#23724" class="Primitive Operator">_*_</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="43144" class="Symbol">{-#</a> <a id="43148" class="Keyword">BUILTIN</a> <a id="43156" class="Pragma">NATPLUS</a> <a id="43164" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#16727" class="Primitive Operator">_+_</a> <a id="43168" class="Symbol">#-}</a>
<a id="43172" class="Symbol">{-#</a> <a id="43176" class="Keyword">BUILTIN</a> <a id="43184" class="Pragma">NATTIMES</a> <a id="43193" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#23724" class="Primitive Operator">_*_</a> <a id="43197" class="Symbol">#-}</a>
<a id="43201" class="Symbol">{-#</a> <a id="43205" class="Keyword">BUILTIN</a> <a id="43213" class="Pragma">NATMINUS</a> <a id="43222" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#26753" class="Primitive Operator">_∸_</a> <a id="43226" class="Symbol">#-}</a>
</pre>{% endraw %}
{::comment}
...
{% raw %}<pre class="Agda"><a id="44487" class="Keyword">data</a> <a id="Bin"></a><a id="44492" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#44492" class="Datatype">Bin</a> <a id="44496" class="Symbol">:</a> <a id="44498" class="PrimitiveType">Set</a> <a id="44502" class="Keyword">where</a>
  <a id="Bin.nil"></a><a id="44510" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#44510" class="InductiveConstructor">nil</a> <a id="44514" class="Symbol">:</a> <a id="44516" href="plfa.Naturals.html#44492" class="Datatype">Bin</a>
  <a id="Bin.x0_"></a><a id="44522" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#44522" class="InductiveConstructor Operator">x0_</a> <a id="44526" class="Symbol">:</a> <a id="44528" href="plfa.Naturals.html#44492" class="Datatype">Bin</a> <a id="44532" class="Symbol">→</a> <a id="44534" href="plfa.Naturals.html#44492" class="Datatype">Bin</a>
  <a id="Bin.x1_"></a><a id="44540" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Naturals.md %}{% raw %}#44540" class="InductiveConstructor Operator">x1_</a> <a id="44544" class="Symbol">:</a> <a id="44546" href="plfa.Naturals.html#44492" class="Datatype">Bin</a> <a id="44550" class="Symbol">→</a> <a id="44552" href="plfa.Naturals.html#44492" class="Datatype">Bin</a>
</pre>{% endraw %}
{::comment}
...
{::comment}
{% raw %}<pre class="Agda"><a id="45862" class="Comment">-- Your code goes here</a>
</pre>{% endraw %}{:/}

{% raw %}<pre class="Agda"><a id="45899" class="Comment">-- 请将代码写在此处。</a>
</pre>{% endraw %}
{::comment}
Standard library
{:/}
...
{% raw %}<pre class="Agda"><a id="46286" class="Comment">-- import Data.Nat using (ℕ; zero; suc; _+_; _*_; _^_; _∸_)</a>
</pre>{% endraw %}
{::comment}
